...
def main(dev_type = 'MTLT305D', bcm_pin_list = []): 
    ...
    for i in device_list:
        ...
        test_file = my_csv(os.path.join(os.getcwd(), 'data','result_{0:#X}_{1:#X}_{2}_FW{3}_{4}.csv'.format(i.src, i.sn_can, dev_type, can_attribute['predefine']['fwnum'], loc_time)))
