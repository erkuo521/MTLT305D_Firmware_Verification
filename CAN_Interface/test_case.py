...
class aceinna_test_case():
    ...
    def init_test_dict(self): # ['item', 'function', 'target']
        ...
        self.test_case.append(['3.9', 'test_sensor_status', 'self.test_file.write([item, self.test_sensor_status(targetdata), self.function_measure_data[key]])', [0, 4, 6]])
        ...
        self.test_case.append(['4.1.9', 'test_sensor_status', 'self.test_file.write([item, self.test_sensor_status(targetdata), self.function_measure_data[key]])', [0, 4, 6]])
        ...
        self.test_case.append(['4.2.7', 'set_unit_behavior', 'self.test_file.write([item, self.set_unit_behavior(targetdata), self.function_measure_data[key]])', [222, 1]])
        ...
        self.test_case.append(['5.1.5', 'set_unit_behavior', 'self.test_file.write([item, self.set_unit_behavior(targetdata, saved_rst=True), self.function_measure_data[key]])', [222, 1]])
        ...
        self.test_case.append(['5.2.5', 'set_unit_behavior', 'self.test_file.write([item, self.set_unit_behavior(targetdata, nosaved_rst=True), self.function_measure_data[key]])', [222, 1]])
    ...
    def set_orientation(self, target_data, saved_rst = False, nosaved_rst = False): # 4.2.6 5.1.4 5.2.4
        ...
        if nosaved_rst == True:
            if self.dev.auto_power.enabled: # only if enabled, it will power on and off by gpio automaticaly.  default will not use auto-power, need manual power on and off
                ...
                #     pass
            time.sleep(1)
            target_data = hex(self.dev.default_confi['orientation'][0]*256 + self.dev.default_confi['orientation'][1]) # if no save repower, target data should be update to default value
            self.dev.driver.send_wakeup_msg() 
